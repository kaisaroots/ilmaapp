...
if (min_temp < 0) {
  frost_msg <- paste0("Eile oli ÖÖKÜLM! Min temp: ", round(min_temp,1), "°C", 
                      " (öö keskmine ", round(avg_temp,1), "°C")
} else {
  frost_msg <- paste0("Eile öösel öökülma ei olnud. Min temp: ", round(min_temp,1), "°C",
                      " (öö keskmine ", round(avg_temp,1), "°C)")
}
